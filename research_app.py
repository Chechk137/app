...
with st.sidebar:
    ...
    st.markdown("""
    **1. Raw Score (인기도)**
    : Conventional search score based on citations/journal. (기존 검색 엔진 점수. 인용수와 저널 인지도에 비례.)
    ...
    **3. Bias Penalty (편향)**
    ...
    2. **Prestige Index (저널 권위 지표)**
       : Top Tier journals like Nature, Science. (Nature, Science 등 학계에서 인정받는 최상위 저널)
